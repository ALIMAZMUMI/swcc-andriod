...
//        truck=(CardView)view.findViewById(R.id.truck);
        ...
        GridAdapter adapter2=new GridAdapter(getContext(),R.layout.griditem,birdList2,width,height,1);
        ...
        birdList3.add(new GridItem("تععد بالمحافظة على البطاقات و التصاريح - مقاول",R.drawable.edit));
