...
import com.gov.sa.swcc.model.emptask.GetRemainingTime;

public class GetAllMyTask {
    ...
    @Expose
    private GetRemainingTime getRemainingTime;
    ...
    public GetRemainingTime getGetRemainingTime() {
        return getRemainingTime;
    }

    public void setGetRemainingTime(GetRemainingTime getRemainingTime) {
